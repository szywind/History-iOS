...
class LocalDataManager {
    ...
    let dynasty2index = ["夏":0, "商":1, "西周":2, "春秋":3, "战国":4, "秦":5, "西汉":6, "东汉":7, "三国":8, "西晋":9, "南北朝":10,
                         "隋":11, "唐":12, "五代十国":13, "北宋":14, "辽":15, "金":16, "南宋":17, "元":18, "明":19, "清":20]
    let index2dynasty = ["夏", "商", "西周", "春秋", "战国", "秦", "西汉", "东汉", "三国", "西晋", "南北朝",
...
//        allRecords = BaseViewController.allPeople + BaseViewController.allEvents
