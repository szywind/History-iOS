...
class DraftViewController: UIViewController {
    ...
    @IBOutlet weak var drafttimeline: ISTimeline!
    ...
    override func viewDidLoad() {
        ...
        drafttimeline.contentInset = UIEdgeInsetsMake(20.0, 20.0, 20.0, 20.0)
        drafttimeline.linePositionX = self.view.frame.width / 2.0 + drafttimeline.bounds.origin.x
        drafttimeline.points = myPoints
    }
